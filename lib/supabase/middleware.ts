...
export async function updateSession(request: NextRequest) {
    ...
    const publicPaths = ['/tarifs', '/login', '/signup', '/auth', '/api', '/_next', '/static', '/favicon.ico', '/pricing', '/', '/success', '/vip-spectacle', '/acces-prive-atelier', '/tutoriel', '/impersonate', '/update-password'];
