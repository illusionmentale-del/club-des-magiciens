                ...
                {items.length > 0 ? (
                    items.map(item => {
                        ...
                        return (
                            ...
                            >
                                <div className="bg-[#111] border border-white/5 rounded-xl p-4 flex items-center gap-4 hover:bg-[#1a1a1f] transition-all hover:border-magic-royal/30 group-hover:translate-x-1 duration-300 shadow-sm">
                                    {/* Thumbnail / Icon */}
                                    <div className="w-16 h-16 bg-black rounded-lg shrink-0 overflow-hidden relative border border-white/5">
                                        ...
                                        <div className="absolute top-1 right-1 bg-magic-royal text-black text-[8px] font-bold px-1.5 py-0.5 rounded uppercase shadow-sm">New</div>
                                    </div>

                                    {/* Info */}
                                    <div>
                                        <h4 className="font-bold text-white group-hover:text-magic-royal transition-colors line-clamp-1 text-sm md:text-base">{item.title}</h4>
                                    ...
                                    <div className="ml-auto opacity-50 group-hover:opacity-100 transition-opacity">
                                        <ArrowRight className="w-4 h-4 text-slate-500 group-hover:text-magic-royal transition-colors transform group-hover:translate-x-1 duration-300" />
                                    </div>
                                </div>
                            </Link>
                        )
