...
export default function AdultHomeHero({
    ...
    return (
        <section className="relative group scroll-mt-24 mb-16">
            ...
            <div className="absolute -inset-1 bg-gradient-to-r from-magic-royal/20 to-transparent rounded-3xl opacity-30 blur-xl group-hover:opacity-50 transition duration-1000"></div>

            <div className="relative bg-black border border-white/10 hover:border-magic-royal/30 transition-colors duration-500 rounded-2xl overflow-hidden shadow-2xl flex flex-col md:flex-row">
                {/* Thumbnail Side */}
                <div className="md:w-3/5 relative aspect-video md:aspect-auto bg-[#0a0a0f] overflow-hidden">
                    ...
                    <div className="absolute top-6 left-6 z-20">
                        <span className="bg-magic-royal text-black text-[10px] font-black px-4 py-1.5 rounded-full uppercase tracking-[0.2em] shadow-[0_0_20px_rgba(238,195,67,0.3)] flex items-center gap-2">
                ...
                <div className="md:w-2/5 p-8 md:p-12 flex flex-col justify-center bg-gradient-to-br from-[#111] to-black relative border-t md:border-t-0 md:border-l border-white/5">
                    {/* subtle inner glow */}
                    <div className="absolute top-0 right-0 w-64 h-64 bg-magic-royal/5 blur-[80px] rounded-full pointer-events-none hidden md:block"></div>

                    <div className="mb-auto relative z-10">
                        <h2 className="text-3xl md:text-4xl font-black font-serif text-white leading-tight mb-6 group-hover:text-magic-royal transition-colors duration-500">
                            {title}
                        </h2>
                    ...
                    <div className="mt-10 relative z-10">
                        <Link
                            href={link || "#"}
                            className="inline-flex w-full items-center justify-center gap-3 bg-magic-royal text-black hover:bg-blue-400 font-bold py-4 px-6 rounded-xl transition-all shadow-[0_0_20px_rgba(238,195,67,0.2)] hover:shadow-[0_0_30px_rgba(238,195,67,0.4)] uppercase tracking-wider text-sm hover:-translate-y-0.5"
                        >
