                    ...
                    <div className="relative w-64 h-full bg-magic-card border-r border-white/10 flex flex-col p-4 animate-in slide-in-from-left duration-200">
                        ...
                        <nav className="space-y-2 flex-1">
                            <Link
                                href="/dashboard/feed"
                                onClick={close}
                                className={`flex items-center gap-3 px-4 py-3 font-medium transition-all ${isActive('/dashboard/feed') ? 'bg-gradient-to-r from-magic-cyan/20 to-transparent text-magic-cyan border-l-2 border-magic-cyan' : 'text-gray-400 hover:bg-white/5 hover:text-white border-l-2 border-transparent'}`}
                            >
