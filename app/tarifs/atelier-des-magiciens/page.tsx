            ...
            <div className="relative z-10 max-w-5xl mx-auto px-4 pt-40 pb-32">
                ...
                <FadeInUp delay={0.1}>
                    <div className="text-center space-y-8 mb-24">
                        <div className="inline-flex items-center gap-2 px-6 py-2 border border-white/10 bg-white/5 rounded-full text-[#f5f5f7] text-xs font-semibold tracking-widest uppercase backdrop-blur-md">
                            <Sparkles className="w-4 h-4 text-[#86868b]" />
                            L'Atelier des Magiciens
                        </div>
                        <h1 className="text-5xl md:text-8xl font-semibold tracking-tight text-[#f5f5f7] leading-[1.1]">
                            Passez à la vitesse <br className="hidden md:block" />
                            <span className="text-[#86868b] italic">supérieure.</span>
                        </h1>
                        ...
                        <BentoHoverEffect>
                            <div className="bg-[#0a0a0a] border border-white/10 rounded-[40px] p-10 md:p-14 flex flex-col relative overflow-hidden transition-all duration-700 hover:shadow-[0_0_40px_rgba(168,85,247,0.15)] hover:border-brand-purple/50 group shadow-xl">
                                <div className="mb-8 text-center">
                                    ...
                                    <h2 className="text-4xl font-semibold text-[#f5f5f7] mb-4 tracking-tight">Le Pass Essentiel</h2>
                                    <p className="text-[#86868b] font-light text-lg">Idéal pour découvrir l'Atelier sans contrainte.</p>
                                </div>

                                <div className="mb-10 flex flex-col items-center border-b border-white/5 pb-10">
                                    <div className="flex items-baseline gap-2">
                                        <span className="text-6xl md:text-7xl font-semibold tracking-tighter text-[#f5f5f7]">{monthlyProduct?.price_label || "4,99€"}</span>
                                        <span className="text-[#86868b] font-medium text-xl">/mois</span>
                                    </div>
                                    <span className="text-sm text-[#86868b] mt-4 font-light">Annulable en un clic depuis votre QG.</span>
                                </div>
