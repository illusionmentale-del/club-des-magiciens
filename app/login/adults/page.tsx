    ...
    return (
        ...
        >
            ...
            {pending ? (
                ...
                <span className="text-[15px]">Accéder à l'Atelier</span>
            )}
        </button>
    );
}
        ...
        <div className="w-full max-w-md z-10">
            <div className="text-center mb-10 relative">
                ...
                <h1 className="relative z-10 text-5xl md:text-6xl font-bold tracking-tighter text-white leading-[1.1] mb-4">
                    Bienvenue à <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-purple to-purple-400">l'Atelier</span>
                </h1>
            ...
            <div className="relative bg-[#0a0a0a] border border-white/10 rounded-[24px] p-8 md:p-10 shadow-2xl overflow-hidden">
                <form action={formAction} className="space-y-6 relative">
                    ...
                    <div className="space-y-1">
                        <label className="text-brand-text-muted text-sm font-medium">Identifiant ou Email</label>
                    ...
                    <div className="space-y-1">
                        <div className="flex justify-between items-center">
                            <label className="text-brand-text-muted text-sm font-medium">Mot de passe</label>
