            ...
            <header className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-white/10 pb-6">
                <div>
                    <h1 className="text-3xl font-black text-white flex items-center gap-3">
                        <MessageCircle className="w-8 h-8 text-magic-cyan" />
                        Inbox Adultes
                    </h1>
                ...
                <div className="flex items-center gap-2 p-1 bg-black/40 rounded-xl w-fit border border-white/5 shadow-inner">
                    <Link
                        ...
                        className={cn(
                            ...
                            currentTab === 'unread'
                                ? "bg-magic-cyan text-black shadow-lg"
            ...
            <div className="grid grid-cols-1 gap-6">
                {comments.length === 0 ? (
                    ...
                    comments.map((comment) => {
                        ...
                        return (
                            <div key={comment.id} className="bg-magic-card border border-white/10 rounded-2xl p-6 relative overflow-hidden group hover:border-magic-cyan/30 transition-colors">
                                <div className="absolute top-0 left-0 w-1 h-full bg-magic-cyan"></div>
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div>
                                                ...
                                                <div className="flex items-center gap-4 text-xs text-gray-400 mt-2 font-mono uppercase">
                                                    ...
                                                    {course && (
                                                        <a href={`/watch/${course.id}`} target="_blank" rel="noreferrer" className="flex items-center gap-1 hover:text-magic-cyan transition-colors truncate max-w-[200px]" title={course.title}>
