                ...
                {[
                    ...
                    <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold uppercase tracking-widest text-xs transition-all ${activeTab === tab.id
                            ? "bg-magic-gold text-black shadow-lg shadow-magic-gold/20"
                ...
                <Card className="bg-black border-white/5 shadow-2xl overflow-hidden">
                    <CardHeader className="border-b border-white/5 bg-white/[0.02]">
                        <CardTitle className="text-xl font-serif font-bold tracking-tight flex items-center gap-3 text-white">
                            {activeTab === "featured" && <><Sparkles className="text-magic-gold" /> L'Annonce à la Une</>}
                            {activeTab === "programs" && <><GraduationCap className="text-magic-gold" /> Programmes Principaux</>}
                            {activeTab === "news" && <><Trophy className="text-magic-gold" /> Nouveautés de la Semaine</>}
                            {activeTab === "promo" && <><Store className="text-magic-gold" /> Promo Boutique (Accueil)</>}
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="p-8">
                                        ...
                                        <div className="bg-[#111] border border-white/10 rounded-xl p-4 min-h-[300px] flex flex-col gap-3">
                                            {selectedPrograms.length === 0 ? (
                                                ...
                                                selectedPrograms.map(course => (
                                                    <div key={course.id} className="flex items-center gap-4 bg-black/50 border border-magic-gold/30 rounded-lg p-3">
                        ...
                        {activeTab === "news" && (
                            <div className="space-y-6">
                                        ...
                                        {availableCourses.map(course => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`p-4 rounded-xl border transition-all cursor-pointer flex items-center gap-3 ${isSelected ? 'bg-magic-gold/10 border-magic-gold/50' : 'bg-[#111] border-white/10 hover:border-white/20'
                                                        }`}
                                                >
                                                    <div className={`w-5 h-5 rounded border flex items-center justify-center transition-all ${isSelected ? 'bg-magic-gold border-magic-gold' : 'bg-transparent border-white/20'
                                                        }`}>
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-sm font-bold text-black uppercase tracking-widest bg-magic-gold p-2 rounded-lg border border-magic-gold shadow-[0_0_15px_rgba(255,215,0,0.3)]">
                                    ...
                                    <div className="p-6 border border-white/10 bg-[#111] rounded-xl space-y-4">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="space-y-2">
                                                ...
                                                <select
                                                    ...
                                                    className="w-full bg-black border border-white/10 rounded-lg p-2 text-white text-sm focus:border-magic-gold/50 outline-none"
                                                >
                                        ...
                                        <Button
                                            ...
                                            className="w-full bg-magic-gold/20 text-magic-gold border border-magic-gold/50 hover:bg-magic-gold hover:text-black"
                                        >
