        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1 space-y-2">
                {[
                    ...
                    <button
                        ...
                        className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl font-bold uppercase tracking-widest text-xs transition-all ${activeTab === tab.id
                            ? "bg-magic-cyan text-black shadow-lg shadow-magic-cyan/20"
                ...
                <Button
                    onClick={handleSave}
                    disabled={loading}
                    className="w-full bg-magic-cyan text-black hover:bg-cyan-400 font-bold"
                >
                ...
                <Card className="bg-black border-white/5 shadow-2xl overflow-hidden">
                    <CardHeader className="border-b border-white/5 bg-white/[0.02]">
                        <CardTitle className="text-xl font-serif font-bold tracking-tight flex items-center gap-3 text-white">
                            {activeTab === "featured" && <><Sparkles className="text-magic-cyan" /> L'Annonce à la Une</>}
                            {activeTab === "programs" && <><GraduationCap className="text-magic-cyan" /> Programmes Principaux</>}
                            {activeTab === "news" && <><Trophy className="text-magic-cyan" /> Nouveautés de la Semaine</>}
                            {activeTab === "promo" && <><Store className="text-magic-cyan" /> Promo Boutique (Accueil)</>}
                        </CardTitle>
                    </CardHeader>
                    <CardContent className="p-8">
                            ...
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-3">
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-[#111] border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:border-magic-cyan/50"
                                ...
                                <div className="space-y-3">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full h-32 bg-[#111] border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:border-magic-cyan/50"
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-sm font-bold uppercase tracking-widest text-magic-cyan flex items-center gap-2">
                                        ...
                                        <div className="bg-[#111] border border-white/10 rounded-xl p-4 min-h-[300px] flex flex-col gap-3">
                                            {selectedPrograms.length === 0 ? (
                                                ...
                                                selectedPrograms.map(course => (
                                                    <div key={course.id} className="flex items-center gap-4 bg-black/50 border border-magic-cyan/30 rounded-lg p-3">
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="relative mb-4">
                                            ...
                                            <input
                                                ...
                                                className="w-full bg-[#111] border border-white/10 rounded-lg py-2 pl-9 pr-4 text-sm text-white focus:outline-none focus:border-magic-cyan/50"
                                            />
                                        </div>
                                                ...
                                                filteredPrograms.map(course => {
                                                    ...
                                                    return (
                                                        <div key={course.id} className="flex items-center gap-3 hover:bg-white/5 rounded-lg p-2 transition-colors cursor-pointer" onClick={() => toggleProgramSelection(course.id)}>
                                                            ...
                                                            <button className="text-magic-cyan hover:text-cyan-400 p-1">
                        ...
                        {activeTab === "news" && (
                            <div className="space-y-6">
                                        ...
                                        {availableCourses.map(course => {
                                            ...
                                            return (
                                                <div
                                                    ...
                                                    className={`p-4 rounded-xl border transition-all cursor-pointer flex items-center gap-3 ${isSelected ? 'bg-magic-cyan/10 border-magic-cyan/50' : 'bg-[#111] border-white/10 hover:border-white/20'
                                                        }`}
                                                >
                                                    <div className={`w-5 h-5 rounded border flex items-center justify-center transition-all ${isSelected ? 'bg-magic-cyan border-magic-cyan' : 'bg-transparent border-white/20'
                                                        }`}>
                                ...
                                <div className="space-y-4">
                                    <h3 className="text-sm font-bold text-black uppercase tracking-widest bg-magic-cyan p-2 rounded-lg border border-magic-cyan shadow-[0_0_15px_rgba(255,215,0,0.3)]">
                                    ...
                                    <div className="p-6 border border-white/10 bg-[#111] rounded-xl space-y-4">
                                        <div className="grid grid-cols-2 gap-4">
                                            <div className="space-y-2">
                                                ...
                                                <select
                                                    ...
                                                    className="w-full bg-black border border-white/10 rounded-lg p-2 text-white text-sm focus:border-magic-cyan/50 outline-none"
                                                >
                                        ...
                                        <Button
                                            ...
                                            className="w-full bg-magic-cyan/20 text-magic-cyan border border-magic-cyan/50 hover:bg-magic-cyan hover:text-black"
                                        >
                                ...
                                <div className="grid grid-cols-1 gap-6">
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <textarea
                                            ...
                                            className="w-full h-24 bg-[#111] border border-white/10 rounded-xl p-4 text-white focus:outline-none focus:border-magic-cyan/50"
