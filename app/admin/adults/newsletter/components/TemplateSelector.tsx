                    ...
                    return (
                        <button
                            ...
                            className={`p-4 rounded-2xl border text-left flex flex-col items-start gap-4 transition-all relative overflow-hidden group ${isSelected
                                    ? 'bg-brand-cyan/10 border-brand-cyan shadow-[0_0_20px_rgba(234,179,8,0.15)]'
                        ...
                        >
                            ...
                            <div className={`p-3 rounded-xl ${isSelected ? 'bg-brand-cyan/20' : 'bg-white/5 group-hover:bg-white/10'}`}>
                                <Icon className={`w-6 h-6 ${isSelected ? 'text-brand-cyan' : 'text-brand-text-muted'}`} />
                            </div>

                            <div>
                                <h3 className={`font-bold text-sm mb-1 ${isSelected ? 'text-brand-cyan' : 'text-white'}`}>{t.name}</h3>
