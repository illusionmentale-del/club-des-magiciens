...
export default function RequestItemAdult({ request }: { request: any }) {
    ...
    return (
        <div className="bg-[#100b1a] bg-[#100b1a] border border-white/5 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.5)] hover:border-brand-purple/30 transition-all rounded-[32px] p-6 md:p-8 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-8 hover:border-brand-purple/30 transition-colors">
