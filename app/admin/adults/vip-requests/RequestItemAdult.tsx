        ...
        <div className="bg-[#1c1c1e] border border-white/5 rounded-[32px] p-6 md:p-8 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-8 hover:border-brand-purple/30 transition-colors">
            <div className="space-y-6 flex-1">
                <div className="flex items-center gap-4 relative">
                    ...
                    <div>
                        <h3 className="font-semibold text-[#f5f5f7] text-xl tracking-tight">{request.full_name}</h3>
                        <p className="text-[#86868b] text-sm flex items-center gap-2 mt-1">
                ...
                <div className="bg-black/30 rounded-[24px] p-5 border border-white/5 space-y-2">
                    <p className="text-sm text-[#f5f5f7] font-medium flex items-center gap-2">
                        <MapPin className="w-4 h-4 text-[#86868b]" />
                        Contexte de rencontre
                    </p>
                    <p className="text-[#86868b] font-light leading-relaxed">"{request.context}"</p>
                </div>
                
                <p className="text-xs text-[#86868b] flex items-center gap-2 font-medium">
