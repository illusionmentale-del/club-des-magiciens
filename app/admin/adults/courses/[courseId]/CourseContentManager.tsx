    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between bg-black/20 p-4 rounded-xl border border-white/5">
                ...
                <Button onClick={openAdd} className="bg-brand-blue text-black hover:bg-brand-blue/80 font-bold" disabled={isAdding || isEditing !== null}>
            ...
            <div className="space-y-3">
                {videos.map((video) => (
                    <div key={video.id} className="bg-brand-card border border-white/5 rounded-xl p-4 flex flex-col md:flex-row gap-4 items-start md:items-center hover:border-brand-blue/20 transition-colors">
                        
                        <div className="flex items-center justify-center cursor-move text-gray-500 opacity-50 hover:opacity-100">
                            <GripVertical className="w-5 h-5" />
                        </div>

                        <div className="w-16 h-12 bg-black/50 rounded-lg flex items-center justify-center border border-white/10 shrink-0 text-brand-blue">
            ...
            {/* Edit / Add Form */}
            {(isAdding || isEditing) && (
                <div className="bg-brand-bg border border-brand-blue/30 rounded-2xl p-6 space-y-4 shadow-2xl relative">
                    <button onClick={cancelEdit} className="absolute top-4 right-4 text-gray-400 hover:text-white">
                        <X className="w-5 h-5" />
                    </button>
                    
                    <h3 className="text-lg font-bold text-brand-blue mb-4 border-b border-white/10 pb-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full bg-black/40 border border-white/10 rounded-lg p-3 text-white focus:outline-none focus:border-brand-blue/50"
                        ...
                        <div className="space-y-2 md:col-span-2">
                            ...
                            <textarea
                                ...
                                className="w-full bg-black/40 border border-white/10 rounded-lg p-3 text-white h-24 focus:outline-none focus:border-brand-blue/50"
                            />
                        </div>
                        <div className="space-y-2">
                    ...
                    <div className="pt-4 flex justify-end gap-3 border-t border-white/5 mt-4">
                        ...
                        <Button onClick={handleSave} disabled={loading} className="bg-brand-blue text-black hover:bg-brand-blue/80 font-bold">
