            ...
            <div className="w-full h-[calc(100dvh-6rem)] bg-black rounded-3xl overflow-hidden shadow-2xl relative mt-4 flex flex-col lg:flex-row">
                <div className="relative w-full lg:flex-1 h-[30vh] lg:h-auto">
                    ...
                    <button
                        ...
                        className="absolute top-4 left-4 px-4 py-2 bg-red-500 hover:bg-red-600 text-white text-sm font-bold rounded-xl shadow-md transition-colors z-50"
                    >
                        Sortir du Live
                    </button>
                </div>
    ...
    return (
        <div className="min-h-screen bg-[#050507] text-white p-4 md:p-8 pb-32 font-sans selection:bg-purple-500/30 overflow-hidden relative">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-white/5 pb-8">
                    <div>
                        <div className="flex items-center gap-3 mb-3">
                            ...
                            <span className="text-red-500 text-xs font-bold tracking-[0.2em] uppercase">Salle de Diffusion</span>
                        </div>
            ...
            <div className="max-w-4xl mx-auto relative z-10">
                {live ? (
                    <div className="bg-[#0F1014] p-8 md:p-12 border border-white/5 relative overflow-hidden group hover:border-red-500/20 transition-all">
                        {/* Tech Corners */}
                        ...
                        <div className="absolute bottom-0 left-0 w-8 h-8 border-b border-l border-white/10 group-hover:border-red-500/50 transition-colors"></div>

                        <h2 className="text-3xl font-bold mb-4 text-white uppercase tracking-tight">{live.title}</h2>

                        <div className="flex items-center gap-4 mb-8">
                            <div className={`px-3 py-1 rounded border text-xs font-mono uppercase tracking-widest ${live.status === 'en_cours' ? 'bg-red-500/10 border-red-500/50 text-red-500' : 'bg-slate-800 border-slate-700 text-slate-400'}`}>
                        ...
                        {live.status === 'en_cours' ? (
                            <button
                                ...
                                className="w-full py-6 bg-red-600 hover:bg-red-500 text-white font-bold text-xl uppercase tracking-widest transition-all shadow-[0_0_30px_rgba(220,38,38,0.4)] flex items-center justify-center gap-4 group/btn relative overflow-hidden border border-red-400"
                            >
                            ...
                            <div className="bg-black/40 border border-white/5 p-6 text-slate-500 font-mono text-sm uppercase tracking-widest flex items-center justify-center gap-4">
                    ...
                    <div className="flex flex-col items-center justify-center py-32 border border-dashed border-white/5 bg-[#0F1014]/50 rounded-3xl">
                        <div className="w-24 h-24 bg-[#0F1014] border border-white/10 rounded-full flex items-center justify-center mb-6 opacity-50">
                            <Video className="w-10 h-10 text-slate-600" />
                        </div>
                        <h3 className="text-2xl font-bold text-white mb-2 uppercase tracking-widest">Aucun Signal</h3>
                        <p className="text-slate-500 font-mono text-sm uppercase tracking-wider">Aucun live programmé pour le moment.</p>
                    </div>
                )}
            </div>
        </div>
