...
export default async function CatalogPage() {
    ...
    return (
        <div className="min-h-screen bg-[#050507] text-white p-4 md:p-8 pb-32 font-sans relative selection:bg-magic-cyan/30">
            ...
            <div className="absolute top-[20%] right-[-10%] w-[40%] h-[40%] bg-magic-cyan/5 blur-[120px] rounded-full pointer-events-none mix-blend-screen"></div>
                ...
                <header className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4 pt-4">
                    <div className="flex-1">
                        <div className="flex items-center gap-2 text-magic-cyan mb-2">
                            ...
                            <span className="text-xs font-bold uppercase tracking-widest text-magic-cyan">Accès Premium Seulement</span>
                        </div>
                        <h1 className="text-3xl md:text-5xl font-black text-white tracking-tight font-serif">
                            La <span className="text-magic-cyan">Boutique</span>
                        </h1>
