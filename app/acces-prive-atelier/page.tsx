...
export default function VIPAdultRequestPage() {
    return (
        <div className="min-h-screen bg-brand-bg flex flex-col relative font-sans selection:bg-brand-purple/30">
            ...
            <header className="w-full p-6 relative z-10 flex justify-center">
                <Link href="/" className="group flex items-center gap-3">
                    <div className="relative w-12 h-12 flex items-center justify-center bg-black border border-white/10 rounded-xl overflow-hidden group-hover:border-brand-purple/50 transition-colors shadow-[0_0_15px_rgba(255,255,255,0.05)]">
            ...
            <main className="flex-1 flex items-center justify-center relative p-4 mb-12 mt-4 z-10">
                <div className="max-w-md w-full relative bg-[#0a0a0a] border border-white/10 rounded-[24px] p-8 md:p-10 shadow-2xl overflow-hidden">
                    ...
                    <div className="flex justify-center mb-8 relative">
                        <div className="relative w-full max-w-[240px] aspect-[1.6/1] bg-gradient-to-br from-gray-900 to-black rounded-xl border border-brand-purple/30 shadow-[0_15px_40px_rgba(255,255,255,0.05)] flex flex-col items-center justify-center overflow-hidden group hover:border-brand-purple/50 transition-all duration-500">
                            {/* Inner glows */}
                            <div className="absolute top-0 right-0 w-24 h-24 bg-brand-purple/20 blur-[30px] group-hover:bg-brand-purple/30 transition-colors duration-700"></div>
                            <div className="absolute bottom-0 left-0 w-32 h-32 bg-white/5 blur-[40px]"></div>
                            
                            <div className="w-12 h-12 bg-black border border-brand-purple/50 rounded-full flex items-center justify-center mb-3 shadow-[0_0_20px_rgba(168,85,247,0.3)] relative z-10">
                            ...
                            <span className="text-[9px] uppercase tracking-[0.2em] text-brand-purple mt-1 relative z-10">L'Atelier des Magiciens</span>
                            
                            <div className="absolute inset-x-0 bottom-0 h-1 bg-gradient-to-r from-transparent via-brand-purple/50 to-transparent"></div>
                        </div>
                    </div>
